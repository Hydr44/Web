  ...
  return (
    <div className="space-y-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                <h1 className="text-3xl lg:text-4xl font-bold text-slate-100 mb-2">
                  Analytics <span className="bg-gradient-to-r from-blue-600 to-emerald-500 bg-clip-text text-transparent">{orgData?.name}</span>
                </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-blue-50/30 border border-primary/20 ">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Team completo</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-emerald-400 font-medium">+{analytics.growthRate}%</span>
            <span className="text-slate-500">vs mese scorso</span>
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-purple-50/30 border border-purple-200/50 ">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-100">Engagement</h3>
              <p className="text-sm text-slate-400">Membri attivi</p>
            </div>
          </div>
          <div className="text-3xl font-bold text-slate-100 mb-2">
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-orange-50/30 border border-orange-200/50 ">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-100">Tempo Medio</h3>
              <p className="text-sm text-slate-400">Per sessione</p>
            </div>
          </div>
          <div className="text-3xl font-bold text-slate-100 mb-2">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="p-6 rounded-2xl bg-[#1a2536] border border-[#243044] ">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold text-slate-100">Trend Attività</h3>
              ...
              <div key={index} className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <div 
                      className="h-6 bg-gradient-to-r from-blue-600 to-emerald-500 rounded-full"
                      style={{ width: `${(day.activities / 25) * 100}%` }}
                    ></div>
                    <span className="text-sm font-medium text-slate-100">{day.activities}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="p-6 rounded-2xl bg-[#1a2536] border border-[#243044] ">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold text-slate-100">Azioni Più Frequenti</h3>
            <div className="flex items-center gap-2 text-sm text-slate-500">
          ...
          <div className="space-y-4">
            {analytics.topActions.map((action, index) => (
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#1a2536] flex items-center justify-center text-sm font-medium text-slate-400">
                    {index + 1}
                  </div>
                  <div>
                    <h4 className="font-medium text-slate-100">{action.action}</h4>
                    <p className="text-sm text-slate-400">{action.count} volte</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-slate-100">{action.percentage}%</div>
                  <div className="w-16 h-2 bg-[#243044] rounded-full overflow-hidden">
                    <div 
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Device Usage */}
        <div className="p-6 rounded-2xl bg-[#1a2536] border border-[#243044] ">
          <h3 className="text-xl font-semibold text-slate-100 mb-6">Utilizzo Dispositivi</h3>
          
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 rounded bg-blue-500/100"></div>
                <span className="font-medium text-slate-100">Desktop</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-32 h-2 bg-[#243044] rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-blue-500/100"
                    style={{ width: `${analytics.deviceUsage.desktop}%` }}
                  ></div>
                </div>
                <span className="text-sm font-medium text-slate-100">{analytics.deviceUsage.desktop}%</span>
              </div>
            </div>

            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 rounded bg-emerald-500/100"></div>
                <span className="font-medium text-slate-100">Mobile</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-32 h-2 bg-[#243044] rounded-full overflow-hidden">
                  <div 
                ...
                <span className="text-sm font-medium text-slate-100">{analytics.deviceUsage.mobile}%</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-slate-100">Tablet</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-32 h-2 bg-[#243044] rounded-full overflow-hidden">
                  <div 
                ...
                <span className="text-sm font-medium text-slate-100">{analytics.deviceUsage.tablet}%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Peak Hours */}
        <div className="p-6 rounded-2xl bg-[#1a2536] border border-[#243044] ">
          <h3 className="text-xl font-semibold text-slate-100 mb-6">Ore di Picco</h3>
