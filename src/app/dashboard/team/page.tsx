    ...
    <div className="space-y-8">
      ...
      <header className="text-center lg:text-left">
        ...
        <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
          Team & <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">ruoli</span>
        </h1>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-blue-50/30 border border-primary/20 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Amministratori</h3>
              <p className="text-sm text-gray-600">Ruolo admin</p>
            </div>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-purple-50/30 border border-purple-200/50 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Ruolo user</p>
            </div>
          </div>
          <div className="text-3xl font-bold text-gray-900">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50/50 border border-gray-200 shadow-lg">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Gestisci i permessi e i ruoli</p>
            </div>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-primary to-blue-600 text-white text-sm font-medium hover:shadow-lg transition-all duration-200">
        ...
        {currentOrg ? (
          <div className="space-y-3">
            {members.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-600 mb-4">Inizia invitando il primo membro del tuo team</p>
              ...
              members.map((m) => (
                <div key={m.id} className="flex items-center justify-between p-4 rounded-xl bg-white border border-gray-200 hover:border-primary/30 hover:shadow-md transition-all duration-200">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-900 transition-colors">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-600">Seleziona un&apos;organizzazione per vedere i membri del team</p>
          </div>
        )}
      </div>
    </div>
