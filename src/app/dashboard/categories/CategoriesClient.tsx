    ...
    <div className="max-w-3xl">
      ...
      <form onSubmit={onAdd} className="mt-6 flex gap-2 items-end">
        <div className="flex-1">
          <label className="block text-sm font-medium text-gray-600">Nome categoria</label>
          <input
            value={newName}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600">Colore</label>
          <input
            type="color"
            value={newColor}
        ...
        <button
          type="submit"
          disabled={pending}
          className="inline-flex items-center gap-2 h-[42px] px-3 rounded-lg bg-primary text-gray-900 hover:opacity-90 transition disabled:opacity-60"
        >
      ...
      <div className="mt-6">
        {loading ? (
          ...
          <div className="rounded-lg border px-4 py-6 text-sm text-gray-500">
              ...
              <li key={c.id} className="flex items-center gap-3 p-3">
                ...
                {editingId === c.id ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={cancelEdit}
                      className="inline-flex items-center gap-1 px-2 py-1 rounded bg-gray-50 text-gray-800 text-xs"
                      type="button"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => startEdit(c)}
                      className="inline-flex items-center gap-1 px-2 py-1 rounded bg-white ring-1 ring-[#243044] text-xs"
                      type="button"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2 py-1 rounded bg-red-50 text-red-600 ring-1 ring-red-200 text-xs"
                      type="button"
                    >
