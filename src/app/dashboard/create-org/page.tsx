            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200  shadow-lg shadow-black/20 z-10 max-h-48 overflow-y-auto">
                        {addressSuggestions.map((suggestion, index) => (
                          <button
                            ...
                            className="w-full px-4 py-2 text-left hover:bg-white flex items-center gap-2"
                          >
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="taxCode" className="block text-sm font-medium text-gray-600 mb-2">
                      Codice Fiscale
                    </label>
