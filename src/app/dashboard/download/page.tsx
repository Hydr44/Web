    ...
    <div className="space-y-8">
      ...
      <header className="text-center lg:text-left">
        ...
        <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
          I tuoi <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">accessi</span>
        </h1>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50/50 border border-gray-200 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Applicazione completa</p>
            </div>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-blue-50/30 border border-primary/20 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Per autisti</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <span className="px-2 py-1 rounded-md bg-gray-100 text-xs font-medium">iOS</span>
              <span className="px-2 py-1 rounded-md bg-gray-100 text-xs font-medium">Android</span>
            </div>

            <button className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-white border border-gray-200 text-gray-700 font-medium hover:border-primary/30 hover:shadow-md transition-all duration-200">
              <Download className="h-4 w-4" />
              Scarica App Mobile
            </button>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-purple-50/30 border border-purple-200/50 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Dashboard online</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <span className="px-2 py-1 rounded-md bg-gray-100 text-xs font-medium">Chrome</span>
              <span className="px-2 py-1 rounded-md bg-gray-100 text-xs font-medium">Safari</span>
              <span className="px-2 py-1 rounded-md bg-gray-100 text-xs font-medium">Firefox</span>
            </div>
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-primary/5 via-white to-blue-50/30 border border-primary/20 shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Tutto quello che devi sapere</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-600">Tutti i dati sono protetti con crittografia end-to-end</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-600">I dati si sincronizzano automaticamente tra tutti i dispositivi</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-600">Assistenza tecnica disponibile 24/7 per tutti i piani</div>
            </div>
          </div>
        </div>
      </div>
