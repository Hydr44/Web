    ...
    <div className="space-y-8">
      ...
      <header className="text-center lg:text-left">
        ...
        <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
          Le tue <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">impostazioni</span>
        </h1>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-blue-50/30 border border-primary/20 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Password e accessi</p>
            </div>
          </div>
          <div className="text-sm text-gray-600">
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-white to-purple-50/30 border border-purple-200/50 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Preferenze comunicazioni</p>
            </div>
          </div>
          <div className="text-sm text-gray-600">
