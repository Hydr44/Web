  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="p-6  bg-white border border-gray-200 ">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Configurate</p>
            </div>
          </div>
        ...
        <div className="p-6  bg-gradient-to-br from-white to-orange-50/30 border border-orange-200/50 ">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10  bg-gradient-to-r from-orange-500 to-orange-600 flex items-center justify-center">
