...
export default function PrivacySettingsPage() {
  ...
  const handleExportData = async () => {
    try {
      // Qui implementeresti la logica per export dati
  ...
  const handleDeleteAccount = async () => {
    if (confirm("Sei sicuro di voler eliminare il tuo account? Questa azione è irreversibile.")) {
      if (confirm("Questa azione eliminerà definitivamente tutti i tuoi dati. Sei assolutamente sicuro?")) {
        try {
          // Qui implementeresti la logica per eliminare l'account
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">
              Gestione <span className="text-blue-600">Privacy</span>
            </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-lg bg-emerald-500/10 border border-gray-200">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between p-4  bg-white border border-gray-200">
              <div>
                ...
                <p className="text-sm text-gray-500">Dati necessari per il funzionamento del servizio</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4  bg-white border border-gray-200">
              <div>
                ...
                <p className="text-sm text-gray-500">Comunicazioni promozionali e newsletter</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
          ...
          <div className="space-y-6">
            ...
            <div className="p-4  bg-blue-50 border border-blue-200">
              ...
              <div className="space-y-2 text-sm text-blue-600">
                ...
                <div className="flex items-center gap-2">
                  <Database className="h-4 w-4" />
                  <span>Dati organizzazione: {userData?.current_org ? "Presenti" : "Nessuno"}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="h-4 w-4" />
                  <span>Account creato: {userData?.created_at ? new Date(userData.created_at).toLocaleDateString('it-IT') : "N/A"}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4  bg-amber-500/10 border border-amber-500/20">
              ...
              <p className="text-sm text-yellow-800">
                ...
                Assicurati di avere spazio sufficiente per il download.
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4  bg-red-50 border border-red-200">
              ...
              <p className="text-sm text-red-800">
                ...
                inclusi file, documenti e cronologia. Non potrai più accedere al tuo account.
              </p>
            </div>
