/**
 * Proxy: GET /api/leads/pending-activations
 * Lista preventivi pagati in attesa di attivazione manuale (per bell admin)
 */
...
export async function GET(request: Request) {
  ...
  try {
    const response = await fetch(`${LEAD_API_URL}/api/leads/pending-activations`, {
