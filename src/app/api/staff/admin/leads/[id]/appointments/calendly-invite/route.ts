/**
 * Proxy: POST /api/staff/admin/leads/:id/appointments/calendly-invite
 * Invia link Calendly con template brandato + crea appointment placeholder
 */
...
export async function POST(request: Request, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const r = await fetch(`${LEAD_API_URL}/api/leads/${params.id}/appointments/calendly-invite`, {
      method: 'POST',
