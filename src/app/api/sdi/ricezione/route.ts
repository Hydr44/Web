  ...
  try {
    ...
    if (soapEnvelope) {
      ...
      if (soapOperation) {
        ...
        console.log('[SDI] SOAP NamespaceURI:', soapOperation.soapNamespaceURI);
        console.log('[SDI] =====================================');
      } else {
    ...
    if (isFattura) {
      ...
      if (error) {
        ...
        if (soapOperation) {
          ...
          console.log('[SDI] Risposta SOAP generata (errore salvataggio fattura):', soapResponse);
        } else {
          soapResponse = createSOAPResponse('KO', `Errore salvataggio fattura: ${error.message}`);
          responseContentType = getSOAPContentType();
          console.log('[SDI] Risposta SOAP generata (fallback errore salvataggio):', soapResponse);
        }
      ...
      if (soapOperation) {
        ...
        soapResponse = matching.xml;
        responseContentType = matching.contentType;
        console.log('[SDI] Risposta SOAP generata (fattura ricevuta):', soapResponse);
      } else {
        soapResponse = createSOAPResponse('OK', 'Fattura ricevuta e salvata con successo');
        responseContentType = getSOAPContentType();
        console.log('[SDI] Risposta SOAP generata (fallback fattura ricevuta):', soapResponse);
      }
      ...
      if (invoiceError || !invoice) {
        ...
        if (soapOperation) {
          ...
          soapResponse = matching.xml;
          responseContentType = matching.contentType;
          console.log('[SDI] Risposta SOAP generata (notifica senza fattura):', soapResponse);
        } else {
          soapResponse = createSOAPResponse('OK', `Notifica ricevuta (fattura non trovata)`, identificativoSDI || idSDI);
          responseContentType = getSOAPContentType();
          console.log('[SDI] Risposta SOAP generata (fallback notifica senza fattura):', soapResponse);
        }
      ...
      if (updateError) {
        ...
        if (soapOperation) {
          ...
          soapResponse = matching.xml;
          responseContentType = matching.contentType;
          console.log('[SDI] Risposta SOAP generata (errore aggiornamento stato):', soapResponse);
        } else {
          soapResponse = createSOAPResponse('KO', `Errore aggiornamento stato fattura: ${updateError.message}`, identificativoSDI || idSDI);
          responseContentType = getSOAPContentType();
          console.log('[SDI] Risposta SOAP generata (fallback errore aggiornamento):', soapResponse);
        }
      ...
      if (soapOperation) {
        ...
        soapResponse = matching.xml;
        responseContentType = matching.contentType;
        console.log('[SDI] Risposta SOAP generata (notifica):', soapResponse);
      } else {
        soapResponse = createSOAPResponse('OK', statusMessage, identificativoSDI || idSDI);
        responseContentType = getSOAPContentType();
        console.log('[SDI] Risposta SOAP generata (fallback notifica):', soapResponse);
      }
      ...
      if (soapOperation) {
        ...
        soapResponse = matching.xml;
        responseContentType = matching.contentType;
        console.log('[SDI] Risposta SOAP generata (XML non riconosciuto):', soapResponse);
      } else {
        soapResponse = createSOAPResponse('KO', 'XML non riconosciuto come fattura o notifica');
        responseContentType = getSOAPContentType();
        console.log('[SDI] Risposta SOAP generata (fallback XML non riconosciuto):', soapResponse);
      }
