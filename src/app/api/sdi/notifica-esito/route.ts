...
export async function POST(request: NextRequest) {
  try {
    ...
    const certConfig = getSOAPClientConfig('production');
    ...
    try {
      ...
      console.error('[SDI PROD] Errore registrazione evento NotificaEsitoInvio:', eventError);
    }
    ...
    console.error('[SDI PROD] Errore generale NotificaEsito API:', error);
    return NextResponse.json(
      {
        success: false,
