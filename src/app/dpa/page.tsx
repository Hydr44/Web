      ...
      <div className="bg-[#0f172a] pt-28 pb-16">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 text-sm rounded-full border border-blue-500/30 px-4 py-2 mb-6 bg-blue-500/10 text-blue-400 font-medium">
            ...
            Documento III — Data Processing Agreement
          </div>
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">1. Ruoli e Responsabilità</h2>
            </div>
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">2. Oggetto, Natura e Finalità del Trattamento</h2>
            </div>
            <div className="text-gray-700 space-y-4 text-sm leading-relaxed">
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">3. Istruzioni Documentate</h2>
            </div>
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">4. Misure di Sicurezza Tecniche e Organizzative</h2>
            </div>
            <div className="text-gray-700 space-y-4 text-sm leading-relaxed">
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">5. Riservatezza del Personale</h2>
            </div>
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">6. Sub-responsabili del Trattamento</h2>
            </div>
            <div className="text-gray-700 space-y-4 text-sm leading-relaxed">
          ...
          <section className="bg-white rounded-xl border border-red-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">7. Notifica di Violazioni dei Dati (Data Breach)</h2>
            </div>
            <div className="text-gray-700 space-y-3 text-sm leading-relaxed">
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">8. Assistenza al Titolare</h2>
            </div>
            <div className="text-gray-700 text-sm leading-relaxed">
          ...
          <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-900">9. Cancellazione o Restituzione dei Dati</h2>
            </div>
            <div className="text-gray-700 text-sm leading-relaxed">
