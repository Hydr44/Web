      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="space-y-6">
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">1. Ruoli e Responsabilità</h2>
            <div className="text-slate-700 leading-relaxed space-y-4 text-sm">
              <h3 className="font-semibold text-slate-900">1.1 Definizione dei Ruoli</h3>
              ...
              <ul className="list-disc pl-5 space-y-1.5 text-slate-700">
                <li>Il <strong>Cliente</strong> agisce in qualità di Titolare del Trattamento ai sensi dell&apos;art. 4, n. 7, GDPR, in quanto determina autonomamente le finalità e i mezzi del trattamento dei dati relativi alla propria attività</li>
                <li><strong>RescueManager S.r.l.</strong> agisce in qualità di Responsabile del Trattamento ai sensi dell&apos;art. 4, n. 8, GDPR, in quanto tratta i predetti dati esclusivamente per conto del Cliente</li>
              </ul>
              <h3 className="font-semibold text-slate-900">1.2 Nomina</h3>
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">2. Oggetto, Natura e Finalità del Trattamento</h2>
            <div className="text-slate-700 leading-relaxed space-y-4 text-sm">
              <h3 className="font-semibold text-slate-900">2.1 Oggetto</h3>
              ...
              <ul className="list-disc pl-5 space-y-1.5 text-slate-700">
                ...
                <li>Gestire gli interventi di soccorso stradale (richiedenti, veicoli soccorsi, commesse e rendicontazione)</li>
                <li>Fornire funzionalità di reportistica e analisi sui dati del Cliente</li>
              </ul>
              <h3 className="font-semibold text-slate-900">2.2 Categorie dei Dati Trattati</h3>
              <ul className="list-disc pl-5 space-y-1.5 text-slate-700">
                ...
                <li>Dati relativi alle pratiche ambientali: registrazioni RENTRI, FIR digitali, documentazione RVFU</li>
                <li>Dati relativi agli interventi di soccorso stradale: dati del richiedente, luogo e circostanze dell&apos;intervento, veicolo soccorso</li>
              </ul>
              <div className="bg-slate-50 border border-slate-200 p-4">
                <p>Non sono trattati, salvo diversa istruzione scritta del Cliente, dati appartenenti a categorie particolari ai sensi dell&apos;art. 9 GDPR.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">3. Istruzioni Documentate</h2>
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">4. Misure di Sicurezza Tecniche e Organizzative</h2>
            <div className="text-slate-700 leading-relaxed space-y-4 text-sm">
              <h3 className="font-semibold text-slate-900">4.1 Misure Adottate dal Responsabile (Art. 32 GDPR)</h3>
              <ul className="list-disc pl-5 space-y-1.5 text-slate-700">
              ...
              <h3 className="font-semibold text-slate-900">4.2 Misure di Sicurezza dei Sub-responsabili</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-slate-200">
                  <thead className="bg-slate-50">
                    <tr>
                      <th className="border border-slate-200 px-3 py-2 text-left">Sub-responsabile</th>
                      <th className="border border-slate-200 px-3 py-2 text-left">Certificazioni</th>
                      <th className="border border-slate-200 px-3 py-2 text-left">Localizzazione</th>
                      <th className="border border-slate-200 px-3 py-2 text-left">Note sicurezza</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-slate-200 px-3 py-2">Vercel Inc.</td>
                      <td className="border border-slate-200 px-3 py-2">SOC 2 Type 2, ISO 27001</td>
                      <td className="border border-slate-200 px-3 py-2">USA (DPF + SCC)</td>
                      <td className="border border-slate-200 px-3 py-2">Infrastruttura edge; cifratura TLS; auth avanzata</td>
                    </tr>
                    <tr>
                      <td className="border border-slate-200 px-3 py-2">IONOS SE</td>
                      <td className="border border-slate-200 px-3 py-2">ISO 27001</td>
                      <td className="border border-slate-200 px-3 py-2">Germania / UE (SEE)</td>
                      <td className="border border-slate-200 px-3 py-2">Data center certificati; nessun trasferimento extra-UE</td>
                    </tr>
                    <tr>
                      <td className="border border-slate-200 px-3 py-2">Supabase, Inc.</td>
                      <td className="border border-slate-200 px-3 py-2">SOC 2 Type 2</td>
                      <td className="border border-slate-200 px-3 py-2">USA / EU (SCC)</td>
                      <td className="border border-slate-200 px-3 py-2">Row-level security; cifratura database</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-slate-200 px-3 py-2">Standard massimo per dati di pagamento</td>
                    </tr>
                    <tr>
                      <td className="border border-slate-200 px-3 py-2">GoCardless Ltd.</td>
                      <td className="border border-slate-200 px-3 py-2">ISO 27001</td>
                      <td className="border border-slate-200 px-3 py-2">Regno Unito (adeguatezza UE)</td>
                      <td className="border border-slate-200 px-3 py-2">Istituto di pagamento autorizzato; cifratura dei dati dei mandati SDD</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">5. Riservatezza del Personale</h2>
            <div className="text-slate-700 leading-relaxed text-sm">
              <p>Il Responsabile del Trattamento garantisce che le persone autorizzate al trattamento dei dati personali per conto del Cliente (collaboratori, consulenti, dipendenti) siano vincolate da obblighi di riservatezza adeguati (contrattuali o derivanti da obblighi di legge) e abbiano ricevuto adeguata formazione in materia di protezione dei dati personali.</p>
            </div>
          </section>

          {/* 6. Sub-responsabili del Trattamento */}
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">6. Sub-responsabili del Trattamento</h2>
            <div className="text-slate-700 leading-relaxed space-y-4 text-sm">
              <h3 className="font-semibold text-slate-900">6.1 Autorizzazione Generale ed Elenco Aggiornato</h3>
              <p>Il Cliente autorizza in via generale il ricorso ai seguenti sub-responsabili:</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-slate-50 border border-slate-200 p-4 space-y-1">
                  ...
                  <p><strong>Ruolo:</strong> hosting sito web e frontend</p>
                  <p><strong>Sede:</strong> 440 N Barranca Ave #4133, Covina, CA 91723, USA</p>
                  <p><strong>Localizzazione dati:</strong> USA</p>
                  <p><strong>Garanzia:</strong> EU-U.S. DPF + SCC</p>
                </div>
                <div className="bg-slate-50 border border-slate-200 p-4 space-y-1">
                  <p className="font-semibold text-slate-900">IONOS SE</p>
                  <p><strong>Ruolo:</strong> hosting API e backend</p>
                  <p><strong>Sede:</strong> Elgendorfer Str. 57, 56410 Montabaur, Germania</p>
                  <p><strong>Localizzazione dati:</strong> UE / SEE (Germania)</p>
                  <p><strong>Garanzia:</strong> non applicabile, trattamento in SEE</p>
                </div>
                <div className="bg-slate-50 border border-slate-200 p-4 space-y-1">
                  <p className="font-semibold text-slate-900">Supabase, Inc.</p>
                  <p><strong>Ruolo:</strong> database e autenticazione</p>
                  <p><strong>Sede:</strong> 970 Toa Payoh North #07-04, Singapore (entità legale)</p>
                  <p><strong>Localizzazione dati:</strong> USA / EU</p>
                  <p><strong>Garanzia:</strong> SCC</p>
                </div>
                <div className="bg-slate-50 border border-slate-200 p-4 space-y-1">
                  <p className="font-semibold text-slate-900">Stripe Payments Europe, Ltd.</p>
                  <p><strong>Ruolo:</strong> elaborazione pagamenti con carta</p>
                  <p><strong>Sede:</strong> 1 Grand Canal Street Lower, Dublin 2, Irlanda</p>
                  <p><strong>Localizzazione dati:</strong> UE</p>
                  <p><strong>Garanzia:</strong> non applicabile, trattamento in UE</p>
                </div>
                <div className="bg-slate-50 border border-slate-200 p-4 space-y-1 md:col-span-2">
                  <p className="font-semibold text-slate-900">GoCardless Ltd.</p>
                  <p><strong>Ruolo:</strong> gestione addebiti diretti SEPA (SDD) e relativi mandati</p>
                  <p><strong>Sede:</strong> Sutton Yard, 65 Goswell Road, Londra EC1V 7EN, Regno Unito</p>
                  <p><strong>Localizzazione dati:</strong> Regno Unito / UE</p>
                  <p><strong>Garanzia:</strong> decisione di adeguatezza della Commissione UE per il Regno Unito</p>
                </div>
              </div>
              <h3 className="font-semibold text-slate-900">6.2–6.4 Obblighi, Responsabilità e Modifiche</h3>
              <ul className="list-disc pl-5 space-y-1.5 text-slate-700">
                ...
                <li>Eventuali modifiche ai sub-responsabili (aggiunta o sostituzione) sono comunicate con preavviso di almeno 30 giorni</li>
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">7. Notifica di Violazioni dei Dati (Data Breach)</h2>
            <div className="text-slate-700 leading-relaxed space-y-3 text-sm">
              <div className="bg-slate-50 border border-slate-200 p-4">
                <p className="font-semibold text-slate-900 mb-1">7.1 Obbligo di notifica entro 72 ore (Art. 33 GDPR)</p>
                <p>Il Responsabile notifica al Cliente, senza ingiustificato ritardo e comunque entro 72 ore dalla scoperta, qualsiasi violazione dei dati personali che lo riguardi.</p>
              </div>
              ...
              <p>Il Responsabile si impegna a informare tempestivamente il Cliente anche in caso di violazioni comunicate dai propri sub-responsabili (Vercel Inc., IONOS SE, Supabase Inc., Stripe Payments Europe Ltd., GoCardless Ltd.).</p>
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">8. Assistenza al Titolare</h2>
            <div className="text-slate-700 leading-relaxed text-sm">
          ...
          <section className="bg-white border border-slate-200 p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">9. Cancellazione o Restituzione dei Dati</h2>
            <div className="text-slate-700 leading-relaxed text-sm">
              <p>Alla cessazione del contratto di servizio, il Responsabile del Trattamento:</p>
              <ul className="list-disc pl-5 space-y-1.5 text-slate-700 mt-2">
                <li>Rende disponibile al Cliente, per un periodo di 90 giorni dalla cessazione, l&apos;export completo dei dati in formato standard (CSV, JSON o equivalente), in coerenza con l&apos;art. 10 dei Termini e Condizioni e con gli obblighi di portabilità ex Regolamento (UE) 2023/2854 (Data Act)</li>
