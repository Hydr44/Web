    ...
    <main className="min-h-screen bg-[#141c27] pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 mb-8 flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-amber-400 mb-1">Obbligatorio dal 13 Febbraio 2025</h3>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="p-6 rounded-xl bg-[#1a2536] border border-[#243044]">
            ...
            <h3 className="text-lg font-semibold text-slate-100 mb-2">Formulari Digitali (FIR)</h3>
          ...
          <div className="p-6 rounded-xl bg-[#1a2536] border border-[#243044]">
            ...
            <h3 className="text-lg font-semibold text-slate-100 mb-2">MUD Automatico</h3>
            <p className="text-sm text-slate-400">
          ...
          <div className="p-6 rounded-xl bg-[#1a2536] border border-[#243044]">
            ...
            <h3 className="text-lg font-semibold text-slate-100 mb-2">Alert Limiti Giacenza</h3>
            <p className="text-sm text-slate-400">
        ...
        <div className="p-6 rounded-xl bg-[#1a2536] border border-[#243044] mb-12">
          <h3 className="text-lg font-semibold text-slate-100 mb-4">Codici EER Autodemolizioni</h3>
          <div className="grid sm:grid-cols-2 gap-3">
            <div className="text-sm">
              <span className="font-mono text-emerald-400">16 01 06</span>
              <span className="text-slate-400 ml-2">Veicoli fuori uso</span>
            </div>
            <div className="text-sm">
              <span className="font-mono text-emerald-400">16 01 03</span>
              <span className="text-slate-400 ml-2">Pneumatici fuori uso</span>
            </div>
            <div className="text-sm">
              <span className="font-mono text-emerald-400">16 01 07*</span>
              <span className="text-slate-400 ml-2">Filtri olio</span>
            </div>
            <div className="text-sm">
              <span className="font-mono text-emerald-400">13 02 08*</span>
              <span className="text-slate-400 ml-2">Oli motore esausti</span>
            </div>
            <div className="text-sm">
              <span className="font-mono text-emerald-400">16 01 21*</span>
              <span className="text-slate-400 ml-2">Componenti pericolosi</span>
            </div>
            <div className="text-sm">
              <span className="font-mono text-emerald-400">16 01 22</span>
              <span className="text-slate-400 ml-2">Componenti non pericolosi</span>
            </div>
          </div>
        ...
        <div className="p-6 rounded-xl bg-[#1a2536] border border-[#243044] mb-12">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-slate-200">Carico Rifiuto</div>
                <div className="text-xs text-slate-500">Registrazione automatica da demolizione veicolo</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                <div className="text-sm font-medium text-slate-200">Creazione FIR</div>
                <div className="text-xs text-slate-500">Compilazione formulario con dati trasportatore e destinatario</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-medium text-emerald-400">3</span>
              </div>
              <div>
                <div className="text-sm font-medium text-slate-200">Invio Telematico</div>
                <div className="text-xs text-slate-500">Trasmissione al portale RENTRI con firma digitale</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-medium text-blue-400">4</span>
              </div>
              <div>
                <div className="text-sm font-medium text-slate-200">Scarico Automatico</div>
                <div className="text-xs text-slate-500">Aggiornamento giacenze alla ricezione conferma</div>
              </div>
            </div>
          </div>
        </div>
