  ...
  return (
    <main className="min-h-screen bg-white pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 mb-8 flex items-start gap-3">
          <AlertCircle className="h-5 w-5 text-[#2563EB] mt-0.5 flex-shrink-0" />
          <div>
            <h3 className="text-sm font-semibold text-[#2563EB] mb-1">Nodo SDI Certificato</h3>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Generazione XML FatturaPA</h3>
          ...
          <div className="p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Invio Telematico SFTP</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Gestione Notifiche SDI</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Fatture Passive</h3>
            <p className="text-sm text-gray-600">
        ...
        <div className="p-6 rounded-xl bg-gray-50 border border-gray-200 mb-12">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Funzionalità Avanzate</h3>
        ...
        {/* Stati fattura */}
        <div className="p-6 rounded-xl bg-gray-50 border border-gray-200 mb-12">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Stati Fattura SDI</h3>
