      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-4xl space-y-8">
            <div className="p-7 bg-gray-50 border border-gray-200">
      ...
      <section className="py-14 bg-gray-50 border-y border-gray-200">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "Soccorso stradale", desc: "Dispatch, autisti, rapportini con foto e firma, calendario turni" },
              { title: "Radiazioni RVFU", desc: "Demolizione veicoli, certificati, fascicolo digitale, invio a STA" },
              { title: "Fatturazione SDI", desc: "Fatture elettroniche XML, invio automatico, incassi e solleciti" },
              { title: "Registro RENTRI", desc: "Tracciabilità rifiuti, formulari, registri di carico e scarico" },
              { title: "Deposito giudiziario", desc: "Confische, sequestri, registro auto in deposito, scadenze" },
              { title: "App mobile", desc: "App dedicata per autisti con interventi, foto, firme e GPS" },
            ].map((item) => (
              <div
                key={item.title}
